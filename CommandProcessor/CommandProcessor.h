...
public:
    /**
     * @brief The CommandProcessor class is responsible for executing commands and keeping track of the executed commands.
     */
    CommandProcessor();
    /**
     * @brief The CommandProcessor class is responsible for executing commands and keeping track of the executed commands.
     ...
     *
     * @param _newCommand Pointer to a Command object where the retrieved command will be stored.
...
public:
    ...
    /**
     * @brief Adapter class that allows the CommandProcessor to read commands from a file.
     *
     * It is an adapter for the CommandProcessor class.
     */
    FileCommandProcessorAdapter(const FileCommandProcessorAdapter &_other);
    /**
     * @attention The FileLineReader object is not owned by the FileCommandProcessorAdapter object,
     * so it is not deleted in the destructor. Make sure to delete it manually.
     */
    ~FileCommandProcessorAdapter();

    FileCommandProcessorAdapter &operator=(const FileCommandProcessorAdapter &_other);
