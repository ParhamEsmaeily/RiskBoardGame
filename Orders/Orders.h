...
public:
  ...
  Advance(Player* player, Player* target_player, const Territory* source, const Territory* dest, int units);
  ~Advance();
  bool validate();
  void execute();
...
public:
    ...
    Airlift(Player* player, Card* card, const Territory* source, const Territory* dest, int units);
    ~Airlift();
    bool validate();
    void execute();
...
public:
  ...
  Bomb(Player* player, Player* target, Card* card, const Territory* dest);
  ~Bomb();
  bool validate();
  void execute();
...
public:
  ...
  Blockade(Player* player, Player* neutral, Card* card, const Territory* dest);
  ~Blockade();
  bool validate();
  void execute();
...
public:
    ...
    Deploy(Player* player, const Territory* dest, int units);
    ~Deploy();
    bool validate();
    void execute();
...
public:
  ...
  Negotiate(Player* issuer, Player* target, Card* card);
  ~Negotiate();
  bool validate();
  void execute();
