...
void Command::saveEffect(std::string str) {
  m_effect = std::move(str);
  // Output to log file whenever an effect is saved.
  Notify(this);
}

std::string Command::stringToLog() const {
  return "Command stringToLog: " + m_effect;
}
...
std::string GameEngine::stringToLog() const {
  // Prints the current state of the game engine.
