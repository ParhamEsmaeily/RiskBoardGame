    ...
    */
    while (input != "end turn") {
      ...
      if (input == "end turn") {
        ...
        this->order_list->add(Advance(this, &gameMap, target_player, source,
        ...
        this->order_list->add(
            Blockade(this, &gameMap, nullptr, nullptr, nullptr));
        cards_count[CardType::blockade]--;
      } else if (input == "airlift" && cards_count[CardType::airlift] > 0) {
        this->order_list->add(
            Airlift(this, &gameMap, nullptr, nullptr, nullptr, 0));
...
void Player::strategy(const PlayerStrategy *strat) {
